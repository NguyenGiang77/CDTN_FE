...
import './RemedyModalInforCategory.scss';
import { Button, Modal, ModalHeader, ModalFooter, ModalBody } from 'reactstrap'
import {  CommonUtils } from '../../../utils';
class RemedyModalInforCategory extends Component {
    constructor(props) {
        super(props);
        this.state = {
            email: '',
    ...
    handleSendRemedy = () =>{
        this.props.sendRemedyCategory(this.state)
    }
        render(){
...
export default connect(mapStateToProps, mapDispatchToProps)(RemedyModalInforCategory);
