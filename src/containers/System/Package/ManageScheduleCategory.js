...
import './ManageScheduleCategory.scss';
...
class ManageScheduleCategory extends Component {
    constructor(props) { 
        super(props);
        this.state = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ManageScheduleCategory);
